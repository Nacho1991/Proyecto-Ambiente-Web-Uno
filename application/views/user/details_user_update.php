                                            ...
                                            <div class="table-responsive"> 
                                                <center>
                                                    ...
                                                    <div class=form-group>
                                                        ...
                                                        <label>Rol: <input class=form-control type=text value=" . $roleAdministrativo . " name=role /></label> 
                                                    </div>
                                                            ";
                                                            }
                                                            ?>
                                                        <input type="submit" value="Actualizar" class="btn-info" name="btnActualizar">
